                            ...
                            <div className="card-body">
                                ...
                                <div className="flex flex-wrap gap-2 mt-2">
                                    {coreStrengths.map((strength, idx) => (
                                        <span
                                            key={idx}
                                            className="badge badge-primary text-sm px-2 py-2 sm:px-3 sm:py-2 break-words max-w-full">
                                            {strength}
                                        </span>
                                    ))}
                                </div>
                            ...
                            <div className="card-body">
                                ...
                                <div className="flex flex-wrap gap-2 mt-2">
                                    {interests.map((interest, idx) => (
                                        <span
                                            key={idx}
                                            className="badge badge-secondary text-sm px-2 py-2 sm:px-3 sm:py-2 break-words max-w-full">
                                            {interest}
                                        </span>
                                    ))}
                                </div>
